...
If you have don't have [Now CLI](/docs/v2/getting-started/installation#now-cli) on your system, you can install it via the [Now Desktop](https://zeit.co/download), which is the easiest way to get started with Now. You can also install it with `npm` as follows: `npm install -g now`.
