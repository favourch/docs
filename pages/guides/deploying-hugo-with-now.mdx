...
<Note>
  By default, Hugo does not generate a <InlineCode>package.json</InlineCode> so
  you'd have to add a <InlineCode>package.json</InlineCode> file to{' '}
  <InlineCode>my-hugo-project</InlineCode> directory.
</Note>
...
<Caption>
  ...
  <InlineCode>package.json</InlineCode>, containing a script to build a Hugo
  project.{' '}
</Caption>
