...
When your app is deployed, you will receive a deployment URL like the following: [https://my-hugo-project-b7kn7kvjp.now.sh/](https://my-hugo-project-b7kn7kvjp.now.sh/)
