...
When your app is deployed, you will receive a deployment URL like the following: [https://my-hugo-project-8114rrsnl.now.sh/](https://my-hugo-project-8114rrsnl.now.sh/)
