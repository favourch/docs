...
Once you are done running the command, edit the `my-first-post.md` file and add the following:
...
Caching makes your site fast and reduces bandwith consumption for your users. You can configure Now's routes within your `now.json` configuration fole to set up caching headers.
